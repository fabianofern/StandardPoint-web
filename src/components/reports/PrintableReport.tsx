...
const PrintableReport: React.FC<PrintableReportProps> = ({ activeTab, filteredData, reportRef }) => {
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                            ...
                            <div style={{ textAlign: 'center' }}>
                                ...
                                <div style={{ fontSize: '18px', fontWeight: 'bold', color: '#475569' }}>
                                    {projetoAtualObj.vaf?.caracteristicas ? Object.values(projetoAtualObj.vaf.caracteristicas).reduce((a: number, b: any) => a + (Number(b) || 0), 0) : 35}
                                </div>
                            </div>
                        </div>
